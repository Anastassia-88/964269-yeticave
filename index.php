...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            ...
            <?php foreach ($goods as $product_feature => $feature_definition): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=$feature_definition['image']; ?>" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$feature_definition['category']; ?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$feature_definition['name']; ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$feature_definition['price']; ?><b class="rub">р</b></span>
                            </div>
