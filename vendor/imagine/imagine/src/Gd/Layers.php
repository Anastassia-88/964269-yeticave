...
class Layers extends AbstractLayers
{
    ...
    {
        return $this->getClassFactory()->createImage(ClassFactoryInterface::HANDLE_GD, $this->resource, $this->palette,
            new MetadataBag());
    }
    ...
    {
        if (0 === $offset) {
            return $this->getClassFactory()->createImage(ClassFactoryInterface::HANDLE_GD, $this->resource,
                $this->palette, new MetadataBag());
        }
